...
{% include figure.liquid loading="eager" path="assets/img/doc2graphx_multilingual.jpg" class="img-fluid rounded z-depth-1" caption="Multilingual SER comparison (Input / Doc2Graph / Doc2Graph-X / Ground Truth) across Chinese, English, and French forms." %}
