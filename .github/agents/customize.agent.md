...
- **Editing the built site directly** – Never edit generated output. The site is built and published by GitHub Actions. All changes go to `main`.
...
- 🚫 **Never do:**
  ...
  - Edit auto-generated files in `_site/`
  - Make changes that violate the MIT license terms
  - Modify Docker configuration without Docker expertise

## Important Notes

- All changes should be made to the **main** (or **source**) branch
- The published site is built by the **Deploy Jekyll site to Pages** workflow and served as a Pages artifact
